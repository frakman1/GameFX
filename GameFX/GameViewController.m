...
- (void)viewDidLoad {
    ...
    // create volume level max and mins
    ...
    // This section makes it play in the background//
    /////////////////////////////////////////////////////////////////////////////////
...
-(void) viewWillAppear:(BOOL)animated
{
   ...
   // }
    ...
    //NSLog(@"%@", [NSString stringWithFormat:@"merge: %.2f ms", 1000.0 * [end timeIntervalSinceDate:start] / iterations]);
    ...
    LFXHSBKColor *color = [LFXHSBKColor colorWithHue:(hue*360) saturation:0.7 brightness:0.85];
